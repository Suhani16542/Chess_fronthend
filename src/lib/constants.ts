...
export const PROGRAMS = [
  ...
  },
  {
    level: "Advanced",
    badge: "♜ Rook",
    tagline: "Sharpen Your Mastery",
    price: "₹7,999",
    period: "/month",
    color: "gold",
    featured: true,
    features: [
      "Deep positional & strategic play",
      "Complex endgame theory",
      "8 private sessions / month",
      "Competitor game database",
      "Elite tournament entries",
      "GM-reviewed game annotations",
    ],
  },
  {
    level: "Elite Master",
    ...
    features: [
      ...
      "Full competitive preparation",
      "Unlimited session bookings",
      "National & international events",
      "Personal GM coach assignment",
